...
<script>
  ...
  ga('send', 'pageview');
	...
	<title>Projects:  Kapadia & Associates</title>
   ...
   <script src="http://cdn.jsdelivr.net/jquery.mixitup/latest/jquery.mixitup.min.js"></script>
    ...
    <body style="color:#999">
        ...
        <div class="section group" id="Container" style="margin:0 auto;width:80%;min-height:400px;overflow: hidden;">
            <?php
                $fata = fetch_all_popo("project"); $i=0;
                foreach ($fata as $key => $value) {
                    $data = @explode(",", $value['images']);
                    echo '<div class="man mix '.$value['status'].'" data-value="12" >
                            <a href="project_image/opt/'.$data[0].'"  data-lightbox="roadtrip" data-title="'.$value['title'].'('.$value['location'].')">
                                <img src="project_image/thumb/'.$data[0].'" style="width:100%" />
                            </a>
                        </div>';                  
                }
            ?>
