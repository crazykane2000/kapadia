                ...
                <div class="modal-body">
                  <form method="post" action="change_password.php" style="padding: 30px;">
                    ...
                    <div class="form-group">
                      ...
                      <input type="password" placeholder="Enter New Password" value="<?php echo $pdo_auth['pass']; ?>" name="new_pass" class="form-control"  >
                    </div>

                    
                    <div class="form-group">
                      <label style="color: #444">Confirm New Password</label>
                      <input type="password" placeholder="Confirm New Password" name="conf_pass" value="<?php echo $pdo_auth['pass']; ?>" class="form-control"  >
                    </div>
                    <br/>
