                ...
                <div class="col-xl-9 col-xs-12">
                    <div class="card-box items">
                      <div style="padding: 10px;"></div>
                       <h3 style="color: #333;text-align:left;font-size: 20px">Product </h3>
                            ...
                            //echo $lata['address'];
                              ...
                              echo '<tr>
                                ...
                                <tr>
                                 ...
                                 <tr>
                                        <td>Thumbnail</td>
                                        <td><img src="product/main_thumb/'.$lata['thumbnail'].'" /></td>
                                </tr>';
                              ...
                              <td>
                                <?php 
                                  foreach ($images as $key => $value) {
                                    echo '<img src="product/opt/'.$value.'" style="width:200px;padding:10px;" />';
                                  }
                                 ?>
                              </td>     
                           </tr>   
