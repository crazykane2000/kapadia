                    ...
                    <div class="card-box items">
                      <div class="form-group">
                       ...
                       <div class="form-group">
                         ...
                         <textarea class="form-control" required  rows="6" name="product_desc" placeholder="Enter Description Here" style="padding: 10px;"><?php echo $lata['description']; ?></textarea>
                       </div>
